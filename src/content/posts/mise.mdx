...
The database schema:
![Mise Database Schema](/img/projects/mise/mise_db_schema.png)
...
To focus on building the application, I went with [Auth0](https://auth0.com/). Authentication was set up in under an hour, and the documentation was clear. This satisfied the **nimble** constraint—setting up Auth0 in Next.js takes just a few lines of code, so I could easily build custom auth later without losing work.

I considered [NextAuth.js](https://next-auth.js.org/), but classic credentials (email and password) authentication was important for this app. NextAuth.js marks credentials as limited—though this is more about security recommendations than technical capability. Most developers implement credentials auth insecurely (no rate limiting, weak password policies). Auth0 handles these security concerns out of the box, which is the real benefit.
...
![Mise, Typed Prisma](/img/projects/mise/zodError.png)

#### Backend In Practice

Putting all these technologies together in **_Mise_**:

![Mise, Typed Prisma](/img/projects/mise/typedPrisma.png)

Prisma with everything typed out of the box 🚀

![Mise, Typed Input](/img/projects/mise/typedInput.png)
...
For **_Mise_**, I mostly used strategies 1 and 3. Most queries are light enough that re-fetching doesn't cause performance issues, and less code means fewer bugs—helping **reliability**.
...
![Mise, Big Form](/img/projects/mise/bigForm.png)
...
Ordering
![Mise, Kitchen Manager Ordering](/img/projects/mise/kmOrdering.png)

Order Confirmation
![Mise, Kitchen Manager Conf](/img/projects/mise/kmOrderConf.png)

Order Success
![Mise, Kitchen Manager Success](/img/projects/mise/kmOrderSucc.png)
...
![Mise, useState vs useReducer](/img/projects/mise/useStatevsuseReducer.png)
...
![Mise, State Machine Prototype](/img/projects/mise/mise_state_machine.png)
...
![Mise, State Machine Full](/img/projects/mise/xStateFull.png)
...
**_Mise_** will help Candelari's expand. Delicious things are in store 🍽.
